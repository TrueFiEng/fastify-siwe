...
import { siwePlugin, InMemoryStore, siweAuthenticated } from 'fastify-siwe'
...
fastify.post('/siwe/init', {}, async function handler(this: FastifyInstance, req: FastifyRequest, reply: FastifyReply) {
  reply.send({
